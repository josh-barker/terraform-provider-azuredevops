...
func flattenCheckApproval(d *schema.ResourceData, check *pipelineschecks.GenericCheckConfiguration, projectID string) error {
...
func expandCheckApproval(d *schema.ResourceData) (*pipelineschecks.GenericCheckConfiguration, string, error) {
